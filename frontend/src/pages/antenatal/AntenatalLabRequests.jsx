// AntenatalLabRequests.jsx
import React, { useState, useEffect } from "react";
import { useParams } from "react-router-dom";
import axiosInstance from "../../api/axiosInstance";
import AntenatalLayout from "./AntenatalLayout";
import PatientLab  from "../patients/folderComponents/PatientLab";

const AntenatalLabRequests = () => {
  const { pid } = useParams();
  ...
  if (loading) return (
    <AntenatalLayout>
      <div className="min-h-[300px] flex flex-col items-center justify-center gap-3">
        ...
        <p className="text-sm text-violet-600 font-medium">Loading lab requests…</p>
      </div>
    </AntenatalLayout>
  );
...
export default AntenatalLabRequests;